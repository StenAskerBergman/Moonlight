...
namespace RTS_Cam
{
    ...
    public class RTS_Camera : MonoBehaviour
    {
        ...
        public float keyboardMovementSpeed = 55f; //speed with keyboard movement
        public float screenEdgeMovementSpeed = 55f; //spee with screen edge movement
        public float followingSpeed = 5f; //speed when following a target
        public float rotationSped = 250f;
        public float panningSpeed = 25f;
        ...
        public float screenEdgeBorder = 75f;
        ...
        private void Start()
        {
            ...
            screenEdgeBorder = 45f; // The Real Edge Movement Value
            Debug.Log(screenEdgeBorder);
        }
